...
{
    public partial class SubtractionGameForm : Form
    {
        ...
        public SubtractionGameForm(string username, string userId, string email, int coins, int products)
        {
            InitializeComponent();
        ...
        private void GenerateNewQuestion()
        {
            ...
            int num2 = random.Next(1, num1); // Ensure num2 is not greater than num1
